package com.universalcinemas.application.views.películas;
...
@Tag("películas-view")
@JsModule("./views/películas/películas-view.ts")
public class PelículasView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public PelículasView() {
        addClassNames("películas-view", "flex", "flex-col", "h-full");
