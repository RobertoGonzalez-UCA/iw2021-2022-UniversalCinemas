...
import stylesCss from 'themes/universalcinemas/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_universalcinemas_componentCss']) {
    
    document['_vaadintheme_universalcinemas_componentCss'] = true;
  }
