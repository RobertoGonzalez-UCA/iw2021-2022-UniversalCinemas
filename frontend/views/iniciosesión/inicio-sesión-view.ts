...
import SamplePersonModel from 'Frontend/generated/com/universalcinemas/app/data/entity/SamplePersonModel';
import * as SamplePersonEndpoint from 'Frontend/generated/SamplePersonEndpoint';
import { html, PropertyValues } from 'lit';
import { customElement, query } from 'lit/decorators.js';
import { View } from '../view';

@customElement('inicio-sesión-view')
export class InicioSesiónViewElement extends View {
  @query('#countryCode')
